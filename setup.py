...
setup(name='docassemble.VTFeeWaiver',
      ...
      install_requires=['docassemble.ALToolbox>=0.11.0', 'docassemble.AssemblyLine>=3.0.0', 'docassemble.GithubFeedbackForm>=0.4.0', 'docassemble.VTFeedback', 'docassemble.VTSharedYMLFile'],
      zip_safe=False,
